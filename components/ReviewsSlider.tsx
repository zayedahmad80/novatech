    ...
    <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-black to-purple-950/20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10" ref={ref}>
        ...
        <Swiper
          ...
          breakpoints={{
            768: { slidesPerView: 2, coverflowEffect: { rotate: 30, stretch: 0, depth: 80, modifier: 1, slideShadows: true } },
            1024: { slidesPerView: 3, coverflowEffect: { rotate: 20, stretch: 0, depth: 60, modifier: 1, slideShadows: true } },
          }}
              ...
              >
                ...
                <div className="flex items-center gap-4 mt-auto pt-4 border-t border-white/20">
                  ...
                  <div>
                    ...
                    <p className="text-purple-400 text-sm">{review.role || 'Client'}</p>
